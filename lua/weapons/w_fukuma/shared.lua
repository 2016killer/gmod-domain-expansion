...
SWEP.SlotPos = 99
SWEP.DrawAmmo = false
SWEP.PrintName = 'Fukuma Mizushi Nucleus'
...
if CLIENT then
	SWEP.PrintName = language.GetPhrase('fkm.wp.name')
	SWEP.Category = language.GetPhrase('fkm.wp.category')
	SWEP.Instructions = language.GetPhrase('fkm.wp.instructions')
end
